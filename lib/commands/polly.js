...
module.exports = {
    ...
    async execute(message) {
        ...
        if (connection && message.member.voice.channel.id !== message.guild.voice.connection.channel.id) return message.reply('you need to be in the same voice channel as me')
